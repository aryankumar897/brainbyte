...
const AboutCourse = ({course}) => {
  ...
  return (
    ...
    >
      {/* Text Section */}
      <Box sx={{ flex: 1, marginRight: isMobile ? 0 : "20px", marginBottom: isMobile ? "20px" : 0 }}>
        <Typography
          variant="h4"
          sx={{
            fontWeight: "bold",
...
>
  {course?.about}
        ...
        >
          ...
          <li>
            Suitable for aspiring full-stack developers or those specializing in a particular
            technology stack.
          </li>
          <li>
      ...
      >
        <Box
          component="img"
          src="/images/pic3.png" // Replace with your actual image path

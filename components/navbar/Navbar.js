...
const NavBar = () => {
 ...
 const { data: session, status } = useSession()
  ...
  console.log("seeeeee111",useSession())
  ...
  return (
    ...
    <>
      ...
      <AppBar position="static" sx={{ backgroundColor: '#1A1A1A', color: '#fff',    
                   height: 80,
 }}>
        <Toolbar>
          {/* Left Side (Menu Items for larger screens) */}
          <Box display={{ xs: 'none', md: 'flex' }} flexGrow={1} alignItems="center">
          ...
          <Box display="flex" alignItems="center">
            <IconButton sx={{ color: '#fff', display: { xs: 'none', md: 'block' } }}>
              <SearchIcon />
            </IconButton>
            <IconButton sx={{ color: '#fff', display: { xs: 'none', md: 'block' } }}>
              <NotificationsIcon />
        ...
        >
          ...
          <Box
            sx={{ width: 250, backgroundColor: '#1A1A1A', height: '100%', color: '#fff' }}
            role="presentation"
            ...
            <List>
              {menuItems.map((text, index) => (
                <div key={index}  >
                  ...
                  <Divider style={{ width: '100%', height: 1, backgroundColor: '#a3a3c2' }} />

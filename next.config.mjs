...
const nextConfig = {
  env: {
    ...
    GITHUB_CLIENT_ID: config.GITHUB_CLIENT_ID, // GitHub OAuth Client ID
    GITHUB_CLIENT_SECRET: config.GITHUB_CLIENT_SECRET, // GitHub OAuth Client Secret
    FACEBOOK_CLIENT_ID: config.FACEBOOK_CLIENT_ID, // Facebook OAuth Client ID
    FACEBOOK_CLIENT_SECRET: config.FACEBOOK_CLIENT_SECRET, // Facebook OAuth Client Secret
    LINKEDIN_CLIENT_ID: config.LINKEDIN_CLIENT_ID, // LinkedIn OAuth Client ID
    LINKEDIN_CLIENT_SECRET: config.LINKEDIN_CLIENT_SECRET, // LinkedIn OAuth Client Secret

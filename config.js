...
const DB_URI = "mongodb://127.0.0.1:27017/lms"; // Connects to a local MongoDB instance on port 27017
...
const GOOGLE_API_KEY = "AIzaSyB48waIDwpCTAGsthTANJDEupw5FcUq3QE"; // ⚠️ API key should be kept secure
...
const GITHUB_CLIENT_ID = "Ov23lir416Bn2SCOCOmT"; 
const GITHUB_CLIENT_SECRET = "7790b4bb975e9c586a1a55eac31cf1a76cc0b8a9"; // ⚠️ Must be kept secret

// Facebook OAuth credentials (currently empty)
const FACEBOOK_CLIENT_ID = "";
const FACEBOOK_CLIENT_SECRET = "";

// LinkedIn OAuth credentials for authentication
const LINKEDIN_CLIENT_ID = "1270802720441368596";
const LINKEDIN_CLIENT_SECRET = "zk1xRzvjYRB3srOnN-FuMr4CpqwM3i7z"; // ⚠️ Must be kept secret

// Razorpay API keys for handling payments
const RAZORPAY_KEY_ID = "rzp_test_dKqs0H1Gi3Kvf6"; // Public key for Razorpay
const RAZORPAY_KEY_SECRET = "w1JGtUoVg4BsuN2EpjtmGp24"; // ⚠️ Must be kept secret
